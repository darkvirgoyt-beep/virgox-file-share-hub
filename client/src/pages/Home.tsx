...
export default function Home() {
  ...
  const respondMutation = trpc.social.respond.useMutation({
    onSuccess: () => { void requestsQuery.refetch(); void friendsQuery.refetch(); toast.success("Request updated."); },
